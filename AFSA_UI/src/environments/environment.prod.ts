export const environment = {
  production: true,
  useMockData: false,
  coaMappingApiUrl: 'https://coa-mapping-api-746397763597.me-central1.run.app/api/v1',
  ifrsComplianceApiUrl: 'https://ifrs-compliance-api-746397763597.me-central1.run.app/api/v1',
  integrityApiUrl: 'https://fs-integrity-api-746397763597.me-central1.run.app/api/v1',
